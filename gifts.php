...
<html>
    ...
    <body>
            ...
            <div class="header">
                ...
                <div class="header-form col-sm-8 hidden-xs">
                    <div class="form form-inline">
                        ...
                        <div class="form-group">
                            <input type="text" placeholder="San Francisco,CA" class="form-control">
                        </div>
                        <div class="form-group">
        ...
        <div class="recomended-sales">
            <div class="container">
                <h1 class="text-center">Recommended Gifts</h1>
                <p class="text-center"> <img src="img/border.png"/></p>
                <div class="col-sm-12">
                    <div class="col-sm-4">
                        <div class="thumbnail seasonal-thumb">
                            <img src="img/subpage/seasonal_1.png"/>
            ...
            <hr>
            <div class="container">
                <h2 class="text-center">More Gifts and Flowers</h2>
                <p class="text-center"><img src="img/border.png"/></p>
                <div class="col-sm-12" id="more-gift">
                      <div class="col-sm-3">
                        <div class="thumbnail seasonal-thumb">
                            <img src="img/subpage/seasonal_1.png"/>
                            <p id="blue-text">Spa Bath and Body Minted Jasmine Scent Gift Basket</p>
                            <div class="col-sm-5">
                                <h2>$133</h2>
                                <span>75% off</span>
                            </div>

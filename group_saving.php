...
<html>
    ...
    <body>
        <div class="menu">
            ...
            <div class="header">
                <img src="img/subpage/web-header.png">
                <div class="text-section">
                    <h1>Discover the Hub</h1>
        ...
        <div class="web-middle">
            <div class="container">
                ...
                <h2><span>Insurance </span> Group saving programs</h2>
                <hr>
                ...
                <div class="col-sm-12 popular">

                    <div class="col-sm-3">
                        <div class="thumbnail">
                            <img src="img/subpage/popublar-web.png"/>
                            <p class="text-center">
                                <img src="img/subpage/cupon.png"/>
                                view 10 cupons
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-sm-12">
                    <div class="pagination-section">
                        <div class="col-sm-8">
                            <p>Showing 1 out of 100 results</p>
                        </div>
